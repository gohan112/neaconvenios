...
echo ""
echo "  AVISO DE FACTURA: esto deja un ordenador despierto 24 h al día"
echo "  (--min-instances 1), y eso se paga se use o no. Es lo que hace que"
echo "  esta app cueste dinero y tus otras apps de Firebase cuesten 0 €:"
echo "  las otras se duermen solas, esta no puede porque Litestream tiene"
echo "  que estar copiando la base al bucket."
echo ""
echo "  En cuanto pase el evento, duérmela:"
echo "     bash deploy/apagar.sh"
echo "============================================================"
